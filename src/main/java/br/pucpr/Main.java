...
public class Main {
  public static void main(String[] args) {
    ...
    planetas.add(new Planet("Mercúrio", 4879, 57_910_000L,0.39, ROCK));
    planetas.add(new Planet("Vênus", 12104, 108_200_000L,0.72, ROCK));
    planetas.add(new Planet("Terra", 12756, 149_600_000L, 1, ROCK));
    planetas.add(new Planet("Marte", 6792, 227_940_000L, 1.52, ROCK));
    planetas.add(new Planet("Júpiter", 142984, 778_330_000L, 5.20, GAS));
    planetas.add(new Planet("Saturno", 120536, 1_429_400_000L, 9.54, GAS));
    planetas.add(new Planet("Urano", 51118, 2_870_990_000L, 19.22, ICE));
    planetas.add(new Planet("Netuno", 49528, 4_504_300_000L, 30.06, ICE));
    planetas.add(new Planet("Plutão", 2376, 5_906_380_000L, 39.48, DWARF));
    System.out.println();
